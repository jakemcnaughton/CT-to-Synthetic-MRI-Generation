...
from RealUnetTrans import *
#from Unetppfinal import *
#from UnetV2 import *
  ...
  for dirName, subdirList, fileList in os.walk(testctpath):
      for filename in fileList:
          ...
          for i in range(2):
            for j in range(2):
              for k in range(2):
                testx.append(patchify(filetoadd, (96,96,96), step=96)[i,j,k].reshape([1,96,96,96,1]))
  ...
  for dirName, subdirList, fileList in os.walk(testmrpath):
      for filename in fileList:
          ...
          for i in range(2):
            for j in range(2):
              for k in range(2):
                testy.append(patchify(filetoadd, (96,96,96), step=96)[i,j,k].reshape([1,96,96,96,1]))
  ...
  for dirName, subdirList, fileList in os.walk(trainpath):
      for filename in fileList:
          ...
          for i in range(2):
            for j in range(2):
              for k in range(2):
                trainx.append(patchify(filetoadd, (96,96,96), step=96)[i,j,k].reshape([1,96,96,96,1]))
  ...
  for dirName, subdirList, fileList in os.walk(targetpath):
      for filename in fileList:
          ...
          for i in range(2):
            for j in range(2):
              for k in range(2):
                trainy.append(patchify(filetoadd, (96,96,96), step=96)[i,j,k].reshape([1,96,96,96,1]))
  ...
  for dirName, subdirList, fileList in os.walk(valpath1):
      for filename in fileList:
          ...
          for i in range(2):
            for j in range(2):
              for k in range(2):
                valx.append(patchify(filetoadd, (96,96,96), step=96)[i,j,k].reshape([1,96,96,96,1]))
  ...
  for dirName, subdirList, fileList in os.walk(valpath2):
      for filename in fileList:
          ...
          for i in range(2):
            for j in range(2):
              for k in range(2):
                valy.append(patchify(filetoadd, (96,96,96), step=96)[i,j,k].reshape([1,96,96,96,1]))
